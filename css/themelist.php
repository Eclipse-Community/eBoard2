...
$themes = array(
	...
	//Packins
	"defaultsquared"=>"eBoard2 Squared",
...
$themeBylines = array(
	"default"=>"eBoard2 default theme<br />By K4sum1",
    
	"defaultsquared"=>"eBoard2 theme, but without rounded edges<br />By K4sum1",
    "eboard2dark"=>"eBoard2 theme, but dark(er)<br />By K4sum1",
